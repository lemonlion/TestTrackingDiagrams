...
Automatically generates rich interactive HTML reports with PlantUML sequence diagrams, component diagrams, and timeline visualizations from your integration/component test HTTP traffic (real or faked) and telemetry.
