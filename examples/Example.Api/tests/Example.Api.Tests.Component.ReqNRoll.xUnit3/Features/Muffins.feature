...
Feature: Muffins Creation
    ...
    Scenario Outline: Different muffin recipes should produce the expected batch
        ...
        And with the following baking profile:
            | Temperature   | Duration Minutes | Pan Type  |
        ...
        Examples:
            ...
            | Spiced Deluxe    | Almond Flour | Pink Lady    | Saigon       | 190         | 20       | Silicone  | Cinnamon Sugar    | Heavy   | Cream Cheese Swirl | Thick   | 5                       | 2                    |
