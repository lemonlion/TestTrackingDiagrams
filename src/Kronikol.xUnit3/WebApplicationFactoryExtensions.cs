...
public static class WebApplicationFactoryExtensions
{
    ...
    public static HttpClient CreateTestTrackingClient<T>(this WebApplicationFactory<T> factory, XUnitTestTrackingMessageHandlerOptions options, params DelegatingHandler[] additionalHandlers) where T : class
    {
