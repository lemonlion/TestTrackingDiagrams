...
/// </summary>
[Binding]
public class ReqNRollTrackingHooksXUnit3 : ReqNRollTrackingHooks
{
    public ReqNRollTrackingHooksXUnit3(ScenarioContext scenarioContext, FeatureContext featureContext)
        : base(scenarioContext, featureContext) { }
}

[Binding]
public class ReqNRollTestRunHooksXUnit3 : ReqNRollTestRunHooks
{
