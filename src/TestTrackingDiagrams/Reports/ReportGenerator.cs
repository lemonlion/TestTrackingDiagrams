...
public static class ReportGenerator
{
        ...
        string? componentDiagramPlantUml = null)
    {
        ...
        if (isPlantUmlBrowser)
        {
            ...
            body.Append("""<button class="details-radio-btn toggle-btn details-active" data-toggle="headers" data-shown="true" onclick="window._toggleHeaders(this)">Hide Headers</button>""");
            if (hasAssertionNotes)
                body.Append("""<button class="details-radio-btn toggle-btn" data-toggle="assertions" data-shown="false" onclick="window._toggleAssertions(this)">Show Assertions</button>""");
            if (hasStepDelimiters)
                body.Append("""<button class="details-radio-btn toggle-btn details-active" data-toggle="steps" data-shown="true" onclick="window._toggleSteps(this)">Hide Steps</button>""");
        }
        body.Append("</div>");
        body.Append("</div>");
