...
public static class ReportGenerator
{
        ...
        string? componentDiagramPlantUml = null)
    {
        ...
        if (isPlantUmlBrowser)
        {
            ...
            body.Append("""<span class="headers-radio"><span class="details-radio-label">Headers:</span><button class="details-radio-btn headers-radio-btn details-active" data-hstate="shown" onclick="window._setReportHeaders('shown')">Show</button><button class="details-radio-btn headers-radio-btn" data-hstate="hidden" onclick="window._setReportHeaders('hidden')">Hide</button></span>""");
            if (hasAssertionNotes)
                body.Append("""<span class="assertions-radio"><span class="details-radio-label">Assertions:</span><button class="details-radio-btn assertions-radio-btn" data-astate="show" onclick="window._setReportAssertions('show')">Show</button><button class="details-radio-btn assertions-radio-btn details-active" data-astate="hide" onclick="window._setReportAssertions('hide')">Hide</button></span>""");
        }
        body.Append("</div>");
        body.Append("</div>");
