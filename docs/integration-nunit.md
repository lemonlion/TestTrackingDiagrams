# Integration Guide: NUnit

> **Example project:** A complete working example is available at [`Example.Api/tests/Example.Api.Tests.Component.NUnit/`](../Example.Api/tests/Example.Api.Tests.Component.NUnit/). You can reference it alongside this guide for a fully working implementation.
...
```bash
dotnet add package TestTrackingDiagrams.NUnit
...
```xml
<ItemGroup>
    <PackageReference Include="TestTrackingDiagrams.NUnit" Version="1.20.0" />
