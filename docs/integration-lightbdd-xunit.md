# Integration Guide: LightBDD with xUnit

> **Example project:** A complete working example is available at [`Example.Api/tests/Example.Api.Tests.Component.LightBDD/`](../Example.Api/tests/Example.Api.Tests.Component.LightBDD/). You can reference it alongside this guide for a fully working implementation.
...
```bash
dotnet add package TestTrackingDiagrams.LightBDD.XUnit
...
```xml
<ItemGroup>
    <PackageReference Include="TestTrackingDiagrams.LightBDD.XUnit" Version="1.20.0" />
